...
summary 작성 규칙 (3가지 관점으로 구성):
1번째 불릿: "이게 무엇인가?" — 콘텐츠의 핵심을 한 문장으로 명확히 설명
2번째~3번째 불릿: 카테고리에 따라 아래 관점으로 분석
  - 기술동향: "기술적으로 어떤 점이 뛰어난가?" — 핵심 기술, 성능, 차별점
  - 시장동향: "시장에서 어떤 의미가 있는가?" — 시장 규모, 성장성, 트렌드 변화
  - 정부정책: "정책적으로 어떤 영향이 있는가?" — 규제 변화, 보조금, 인증 요건
  - 경쟁사/레퍼런스: "경쟁사 전략에서 배울 점은?" — 타사 접근법, 성과, 시사점
  - 자율주행/로봇: "기술적으로 어떤 점이 뛰어난가?" — 자율주행/로봇 핵심 기술
  - EV/충전인프라: "기술적으로 어떤 점이 뛰어난가?" — 충전/배터리 핵심 기술
  - 기타: "핵심 포인트는 무엇인가?" — 주요 내용 분석
...
summary 작성 규칙 (3가지 관점으로 구성):
1번째 불릿: "이게 무엇인가?" — 핵심을 한 문장으로 설명
2번째~3번째 불릿: 주제에 맞는 핵심 분석 (기술적 우수성, 정책적 영향, 시장 의미 등)
...
summary 구조: 1번째=무엇인가, 2~3번째=핵심 분석(기술/정책/시장 등 주제에 맞게)
